...
namespace Tester
{
    ...
    public class FillDataBase
        : TestBase
    {
        private const int CUSTOMER_COUNT = 1_000;//10_000
        private const int MATERIAL_COUNT = 500;//100_000
        private const int OPERATION_COUNT = 500;//100_000
        private const int EMPLYEE_COUNT = 10;//1_000
        private const int ORDER_COUNT = 1_000;//1_000_000
        ...
        public void FillBase()
        {
            ...
            for (int index = 0; index < ORDER_COUNT; index++)
            {
                ...
                var order = GenerateAndStoreOrder(customerId, orderGroup.Id);
