...
{
    /// <summary>
    /// Interaction logic for frmCustomersList.xaml
    /// </summary>
    public partial class frmCustomersList : Window
    {
        private CustomerListViewModel _viewModel;
        private frmProcessed _process;

        public frmCustomersList(CustomerListViewModel viewModel, Window owner)
        {
            InitializeComponent();
        ...
        {
            var customer = new frmCustomer(viewModel as CustomerViewModel, this);
            customer.ShowDialog();
        }
